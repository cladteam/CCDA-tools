#!/usr/bin/env python3
"""
    Cloned from raw_section_snooper to form the bases of CCDA DQ
    Aimed to parse the CCDA into tabular format
    element[oid,code,concept,value,type,unit,path] (subject to change)
    
    - looks for ANY sections (XML elemnent tagged "section"?),
        within each type:
